...
/**
 * CreateMandateSender Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class CreateMandateSender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateMandateSender';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['user_details']) && (count($this->container['user_details']) > 10)) {
            $invalidProperties[] = "invalid value for 'user_details', number of items must be less than or equal to 10.";
        }
     ...
     *
     * @param string|null $external_user_id Customer App's user ID, representing the end-user making the payment.
     *
     * @return self
     */
     ...
     * Sets user_type
     *
     * @param string|null $user_type Type of account held by the Sender at the Institution. Possible values are INDIVIDUAL, BUSINESS
     *
     * @return self
     */
    ...
    public function setUserDetails($user_details)
    {
        ...
        if ((count($user_details) > 10)) {
            throw new \InvalidArgumentException('invalid value for $user_details when calling CreateMandateSender., number of items must be less than or equal to 10.');
        }
