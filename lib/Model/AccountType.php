...
class AccountType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SUBTYPE_DEBIT_CARD = 'DEBIT_CARD';
    public const SUBTYPE_SECURITIES = 'SECURITIES';
    public const SUBTYPE_FUNDS = 'FUNDS';
    public const SUBTYPE_STOCKS = 'STOCKS';
    public const SUBTYPE_BONDS = 'BONDS';
    public const SUBTYPE_MORTGAGE = 'MORTGAGE';
    public const SUBTYPE_PERSONAL_LOAN = 'PERSONAL_LOAN';
    public const SUBTYPE_REVOLVING_LOAN = 'REVOLVING_LOAN';
    ...
    {
        return [
            self::SUBTYPE_CURRENT,
            self::SUBTYPE_SAVINGS,
            self::SUBTYPE_TIME_DEPOSIT,
            self::SUBTYPE_OTHER,
            self::SUBTYPE_CREDIT_CARD,
            self::SUBTYPE_DEBIT_CARD,
            self::SUBTYPE_SECURITIES,
            self::SUBTYPE_FUNDS,
            self::SUBTYPE_STOCKS,
            self::SUBTYPE_BONDS,
            self::SUBTYPE_MORTGAGE,
            self::SUBTYPE_PERSONAL_LOAN,
            self::SUBTYPE_REVOLVING_LOAN,
