...
/**
 * CreateRecipientAccount Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class CreateRecipientAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRecipientAccount';
    ...
    */
     ...
     *
     * @param string $accountholder_name Accountholder name of the recipient's account
     *
     * @return self
     */
     ...
     * Sets account_type
     *
     * @param string $account_type Type of recipient account.
     *
     * @return self
     */
     ...
     * Sets currencies
     *
     * @param string[] $currencies List of currencies supported by the recipient account
     *
     * @return self
     */
     ...
     * Sets institution_id
     *
     * @param string $institution_id Finverse Institution ID for the recipient’s institution.
     *
     * @return self
     */
