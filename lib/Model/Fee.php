...
class Fee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'currency' => 'currency',
        'paid_by' => 'paid_by',
        'paid_by_account_id' => 'paid_by_account_id'
    ];
    ...
    protected static $setters = [
        ...
        'paid_by' => 'setPaidBy',
        'paid_by_account_id' => 'setPaidByAccountId'
    ];
    ...
    protected static $getters = [
        ...
        'paid_by' => 'getPaidBy',
        'paid_by_account_id' => 'getPaidByAccountId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('paid_by_account_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets amount
     *
     * @param int $amount The amount of fee for a single transaction. Expressed in currency's smallest unit or “minor unit”, as defined in ISO 4217.
     *
     * @return self
     */
    ...
    /**
     * Gets paid_by_account_id
     *
     * @return string|null
     */
    public function getPaidByAccountId()
    {
        return $this->container['paid_by_account_id'];
    }

    /**
     * Sets paid_by_account_id
     *
     * @param string|null $paid_by_account_id The payment account Id
     *
     * @return self
     */
    public function setPaidByAccountId($paid_by_account_id)
    {
        if (is_null($paid_by_account_id)) {
            throw new \InvalidArgumentException('non-nullable paid_by_account_id cannot be null');
        }
        $this->container['paid_by_account_id'] = $paid_by_account_id;
