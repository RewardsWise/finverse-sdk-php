...
/**
 * RefreshLoginIdentityRequest Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class RefreshLoginIdentityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefreshLoginIdentityRequest';
    ...
    protected static $openAPITypes = [
        'user_present' => 'bool',
        'link_customizations' => '\FinversePhp\Model\RefreshLoginIdentityLinkCustomizations'
    ];
    ...
    */
     ...
     * Sets user_present
     *
     * @param bool|null $user_present Indicate whether the user is present in this flow. If the user is not present, only institutions that do not require 2fa can be refreshed
     *
     * @return self
     */
     ...
     *
     * @return \FinversePhp\Model\RefreshLoginIdentityLinkCustomizations|null
     */
     ...
     *
     * @param \FinversePhp\Model\RefreshLoginIdentityLinkCustomizations|null $link_customizations link_customizations
     *
     * @return self
     */
