 ...
 */
class JWKSKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JWKSKey';
    ...
    */
     ...
     * Sets kty
     *
     * @param string|null $kty The \"kty\" (key type) parameter identifies the cryptographic algorithm family used with the key, such as \"RSA\" or \"EC\".
     *
     * @return self
     */
     ...
     * Sets kid
     *
     * @param string|null $kid The \"kid\" (key ID) parameter is used to match a specific key
     *
     * @return self
     */
     ...
     * Sets use
     *
     * @param string|null $use The \"use\" (public key use) parameter identifies the intended use of the public key
     *
     * @return self
     */
     ...
     * Sets e
     *
     * @param string|null $e RSA key value \"e\"
     *
     * @return self
     */
     ...
     * Sets n
     *
     * @param string|null $n RSA key value \"n\"
     *
     * @return self
     */
     ...
     * Sets x5c
     *
     * @param string[]|null $x5c The \"x5c\" (X.509 certificate chain) parameter contains a chain of one or more PKIX certificates
     *
     * @return self
     */
