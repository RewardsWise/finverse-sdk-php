...
class EncryptedPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets ciphertext
     *
     * @param string $ciphertext The credential payload encrypted with AES (base64)
     *
     * @return self
     */
     ...
     *
     * @param string $initialization_vector The 16 byte IV used w/ AES (base64)
     *
     * @return self
     */
     ...
     *
     * @param string $message_authentication_code The MAC to verify AES decryption validity
     *
     * @return self
     */
     ...
     *
     * @param string $envelope_encryption_key The AES key encrypted with an RSA pubkey (base64)
     *
     * @return self
     */
     ...
     * Sets key_id
     *
     * @param string $key_id The identifier of the public key used to encrypt the AES key
     *
     * @return self
     */
