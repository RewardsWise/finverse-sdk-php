...
/**
 * MonthlyIncomeEstimate Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class MonthlyIncomeEstimate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonthlyIncomeEstimate';
    ...
    protected static $openAPITypes = [
        'estimated_income' => '\FinversePhp\Model\IncomeEstimate',
        'month' => 'float',
        'year' => 'float'
    ];
    ...
    {
        $this->setIfExists('estimated_income', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['estimated_income'] === null) {
            $invalidProperties[] = "'estimated_income' can't be null";
        }
     ...
     *
     * @return \FinversePhp\Model\IncomeEstimate
     */
     ...
     *
     * @param \FinversePhp\Model\IncomeEstimate $estimated_income estimated_income
     *
     * @return self
     */
    public function setEstimatedIncome($estimated_income)
    {
        if (is_null($estimated_income)) {
            throw new \InvalidArgumentException('non-nullable estimated_income cannot be null');
        }
     ...
     * Sets month
     *
     * @param float $month The numeric month
     *
     * @return self
     */
