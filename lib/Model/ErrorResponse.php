...
class ErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('app_code', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $http_status_code http_status_code
     *
     * @return self
     */
     ...
     * Sets app_code
     *
     * @param float|null $app_code app_code
     *
     * @return self
     */
    ...
    {
        if (is_null($app_code)) {
            throw new \InvalidArgumentException('non-nullable app_code cannot be null');
        }
     ...
     * Sets error_category
     *
     * @param string|null $error_category error_category
     *
     * @return self
     */
