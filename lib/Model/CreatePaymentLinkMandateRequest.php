...
/**
 * CreatePaymentLinkMandateRequest Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentLinkMandateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentLinkMandateRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_attempt_id'] === null) {
            $invalidProperties[] = "'payment_attempt_id' can't be null";
        }
        if ((mb_strlen($this->container['payment_attempt_id']) > 100)) {
            $invalidProperties[] = "invalid value for 'payment_attempt_id', the character length must be smaller than or equal to 100.";
        }
     ...
     *
     * @param string $payment_attempt_id payment_attempt_id
     *
     * @return self
     */
    public function setPaymentAttemptId($payment_attempt_id)
    {
        ...
        if ((mb_strlen($payment_attempt_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $payment_attempt_id when calling CreatePaymentLinkMandateRequest., must be smaller than or equal to 100.');
        }
     ...
     * Sets sender_type
     *
     * @param string $sender_type The sender type of the mandate
     *
     * @return self
     */
