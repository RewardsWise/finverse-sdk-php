...
/**
 * SetMandateInstitutionRequest Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class SetMandateInstitutionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetMandateInstitutionRequest';
    ...
    */
     ...
     * Sets institution_id
     *
     * @param string $institution_id Finverse Institution ID
     *
     * @return self
     */
    public function setInstitutionId($institution_id)
    {
        ...
        if ((mb_strlen($institution_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $institution_id when calling SetMandateInstitutionRequest., must be smaller than or equal to 100.');
        }
