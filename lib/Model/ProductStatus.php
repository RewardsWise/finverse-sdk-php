...
class ProductStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The current health of this product
     *
     * @return self
     */
     ...
     * Sets status_details
     *
     * @param string|null $status_details The detailed event name
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_successful_update last_successful_update
     *
     * @return self
     */
