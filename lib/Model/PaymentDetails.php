...
class PaymentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'format' => 'setFormat',
        'bic' => 'setBic',
        'bank_fullname' => 'setBankFullname',
        'bank_shortname' => 'setBankShortname',
    ...
    protected static $getters = [
        'format' => 'getFormat',
        'bic' => 'getBic',
        'bank_fullname' => 'getBankFullname',
        'bank_shortname' => 'getBankShortname',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bank_fullname', $data ?? [], null);
        $this->setIfExists('bank_shortname', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['bank_fullname'];
    }

    /**
     * Sets bank_fullname
     *
     * @param string|null $bank_fullname bank_fullname
     *
     * @return self
     */
    public function setBankFullname($bank_fullname)
    {
        if (is_null($bank_fullname)) {
            throw new \InvalidArgumentException('non-nullable bank_fullname cannot be null');
        }
        $this->container['bank_fullname'] = $bank_fullname;
    ...
    {
        return $this->container['bank_shortname'];
    }

    /**
     * Sets bank_shortname
     *
     * @param string|null $bank_shortname bank_shortname
     *
     * @return self
     */
    public function setBankShortname($bank_shortname)
    {
        if (is_null($bank_shortname)) {
            throw new \InvalidArgumentException('non-nullable bank_shortname cannot be null');
        }
        $this->container['bank_shortname'] = $bank_shortname;
