...
/**
 * PaymentLinkDetails Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class PaymentLinkDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentLinkDetails';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_transaction_reference'] === null) {
            $invalidProperties[] = "'external_transaction_reference' can't be null";
        }
        if ((mb_strlen($this->container['external_transaction_reference']) > 35)) {
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PaymentLinkDetails., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param string $external_transaction_reference For external invoice/transaction reference
     *
     * @return self
     */
    public function setExternalTransactionReference($external_transaction_reference)
    {
        ...
        if ((mb_strlen($external_transaction_reference) > 35)) {
            throw new \InvalidArgumentException('invalid length for $external_transaction_reference when calling PaymentLinkDetails., must be smaller than or equal to 35.');
        }
