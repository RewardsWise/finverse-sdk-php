...
/**
 * DownloadBalanceStatementResponse Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class DownloadBalanceStatementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DownloadBalanceStatementResponse';
    ...
    */
     ...
     * Sets download_url
     *
     * @param string $download_url Signed URL to download the CSV from
     *
     * @return self
     */
