...
/**
 * MandateAuthEncryptionInfo Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class MandateAuthEncryptionInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MandateAuthEncryptionInfo';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['jwks_url'] === null) {
            $invalidProperties[] = "'jwks_url' can't be null";
        }
