...
/**
 * PaymentLinkCustomizations Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class PaymentLinkCustomizations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentLinkCustomizations';
    ...
    */
     ...
     * Sets redirect_uri
     *
     * @param string|null $redirect_uri URI to redirect to. Only needed if ui_mode = redirect
     *
     * @return self
     */
