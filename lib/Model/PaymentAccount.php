...
class PaymentAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets raw
     *
     * @param string|null $raw The raw value for the account the user selected when making payment request
     *
     * @return self
     */
     ...
     * Sets institution_id
     *
     * @param string|null $institution_id Finverse Institution ID. Only returned if institution_id was included in the request.
     *
     * @return self
     */
