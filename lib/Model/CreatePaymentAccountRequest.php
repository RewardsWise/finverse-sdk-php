...
class CreatePaymentAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountholder_name'] === null) {
            $invalidProperties[] = "'accountholder_name' can't be null";
        }
     ...
     * Gets account_number
     *
     * @return \FinversePhp\Model\RecipientAccountNumber
     */
     ...
     * Sets account_number
     *
     * @param \FinversePhp\Model\RecipientAccountNumber $account_number account_number
     *
     * @return self
     */
     ...
     * Sets account_type
     *
     * @param string $account_type Type of payment account. Currently only allow creating external account.
     *
     * @return self
     */
     ...
     *
     * @param string $accountholder_name Accountholder name of the payment account
     *
     * @return self
     */
     ...
     * Sets institution_id
     *
     * @param string $institution_id Finverse Institution ID for the payment institution.
     *
     * @return self
     */
    public function setInstitutionId($institution_id)
    {
        ...
        if ((mb_strlen($institution_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $institution_id when calling CreatePaymentAccountRequest., must be smaller than or equal to 100.');
        }
     ...
     * Sets user_id
     *
     * @param string $user_id A unique identifier generated after creating user (Finverse Payment User ID)
     *
     * @return self
     */
    public function setUserId($user_id)
    {
        ...
        if ((mb_strlen($user_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $user_id when calling CreatePaymentAccountRequest., must be smaller than or equal to 100.');
        }
