 ...
 */
class PayoutDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayoutDetails';
    ...
    */
     ...
     * Sets mandate_id
     *
     * @param string $mandate_id The mandate used to execute payments for this payout instruction. Currency for the mandate must be supported by the recipient account
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description for the payment (that will appear as the transaction description on bank statements)
     *
     * @return self
     */
     ...
     * Sets scheduled_date
     *
     * @param \DateTime $scheduled_date YYYY-MM-DD, date (in UTC) to execute the payment, must be 1 day later than current date
     *
     * @return self
     */
