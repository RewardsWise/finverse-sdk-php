...
/**
 * IdentityPhoneNumber Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class IdentityPhoneNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdentityPhoneNumber';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('masked_phone', $data ?? [], null);
    ...
    */
     ...
     * Sets other_phone
     *
     * @param string|null $other_phone other_phone
     *
     * @return self
     */
    ...
    {
        return $this->container['masked_phone'];
    }

    /**
     * Sets masked_phone
     *
     * @param string|null $masked_phone masked_phone
     *
     * @return self
     */
    public function setMaskedPhone($masked_phone)
    {
        if (is_null($masked_phone)) {
            throw new \InvalidArgumentException('non-nullable masked_phone cannot be null');
        }
        $this->container['masked_phone'] = $masked_phone;
