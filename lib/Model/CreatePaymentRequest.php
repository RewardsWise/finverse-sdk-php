    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreatePaymentRequest., must be smaller than or equal to 3.');
        }
     ...
     *
     * @return \FinversePhp\Model\PaymentDetails2
     */
     ...
     *
     * @param \FinversePhp\Model\PaymentDetails2 $payment_details payment_details
     *
     * @return self
     */
