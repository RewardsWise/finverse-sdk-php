...
/**
 * BadRequestModelV2Error Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class BadRequestModelV2Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BadRequestModelV2_error';
    ...
    public const TYPE_LINK_ERROR = 'LINK_ERROR';
    ...
    */
     ...
     * Sets request_id
     *
     * @param string $request_id The request_id provided in the request header
     *
     * @return self
     */
