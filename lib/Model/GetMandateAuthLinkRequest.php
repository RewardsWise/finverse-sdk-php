...
/**
 * GetMandateAuthLinkRequest Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class GetMandateAuthLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetMandateAuthLinkRequest';
    ...
    protected static $openAPITypes = [
        'mandate_id' => 'string',
        'link_customizations' => '\FinversePhp\Model\MandateAuthLinkCustomizations'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['mandate_id']) > 100)) {
            $invalidProperties[] = "invalid value for 'mandate_id', the character length must be smaller than or equal to 100.";
        }

        if ($this->container['link_customizations'] === null) {
            $invalidProperties[] = "'link_customizations' can't be null";
        }
    ...
    public function setMandateId($mandate_id)
    {
        ...
        if ((mb_strlen($mandate_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $mandate_id when calling GetMandateAuthLinkRequest., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \FinversePhp\Model\MandateAuthLinkCustomizations
     */
     ...
     *
     * @param \FinversePhp\Model\MandateAuthLinkCustomizations $link_customizations link_customizations
     *
     * @return self
     */
