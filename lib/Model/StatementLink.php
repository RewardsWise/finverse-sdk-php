...
/**
 * StatementLink Class Doc Comment
 *
 * @category Class
 * @package  FinversePhp
 * @author   OpenAPI Generator team
 ...
 */
class StatementLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatementLink';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url signedURL to download statement
     *
     * @return self
     */
     ...
     * Sets expiry
     *
     * @param \DateTime|null $expiry expiry of the signedURL
     *
     * @return self
     */
